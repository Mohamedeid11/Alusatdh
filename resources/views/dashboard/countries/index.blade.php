...
@section('meta')
    <base href="">
    <title>AL AUSTADH | Country</title>
@endsection
                        ...
                        <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                            ...
                            <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px"
                                ...
                                <div class="px-7 py-5">
                                    ...
                                    <div class="mb-10">
                                        <!--begin::Label-->
                                        <label class="form-label fs-5 fw-bold mb-3">User Type:</label>
                                        <!--end::Label-->
                                        <!--begin::Options-->
                                        <div class="d-flex flex-column flex-wrap fw-bold"
                                            ...
                                            <label
                                                ...
                                                <span
                                                    class="form-check-label text-gray-600">Student</span>
                                            </label>
                                            <!--end::Option-->
                                            <!--begin::Option-->
                                            <label
                                                ...
                                                <span
                                                    class="form-check-label text-gray-600">Teacher</span>
                                            </label>
                                            <!--end::Option-->
                                            <!--begin::Option-->
                                            <label
                                                ...
                                                <span
                                                    class="form-check-label text-gray-600">Admins</span>
                                            </label>
                                            <!--end::Option-->
                                        </div>
                                        <!--end::Options-->
                                    ...
                                    <div class="d-flex flex-column">
                                        ...
                                        <label
                                            ...
                                            <input class="form-check-input" type="checkbox" value="2"
                                                   checked="checked" name="payment_type" />
                                            <span
                                                class="form-check-label text-gray-600 fw-bold">Student</span>
                                        </label>
                                        <!--end::Radio button-->
                                        <!--begin::Radio button-->
                                        <label
                                            ...
                                            <input class="form-check-input" type="checkbox" value="3"
                                                   name="payment_type" />
                                            <span
                                                class="form-check-label text-gray-600 fw-bold">Teacher</span>
                                        </label>
                                        <!--end::Radio button-->
                                        <!--begin::Radio button-->
                                        <label
                                            ...
                                            <input class="form-check-input" type="checkbox" value="4"
                                                   name="payment_type" />
                                            <span
                                                class="form-check-label text-gray-600 fw-bold">Admins</span>
                                        </label>
                                        <!--end::Radio button-->
                                    </div>
                                    <!--end::Input group-->

                                ...
                                <div class="d-flex my-4">
                                    <a href="#" class="btn btn-sm btn-light me-2"
                                       id="kt_user_follow_button">
                                        ...
                                        <span class="indicator-label">Deactive</span>
                                        <!--end::Indicator label-->
                                    ...
                                    <a href="#" class="btn btn-sm btn-primary me-3"
                                       ...
                                       data-bs-target="#kt_modal_offer_a_deal">Login As</a>
                                    <!--begin::Menu-->
                                    <div class="me-0">
                                        <button
                                ...
                                <div class="d-flex flex-column flex-grow-1 pe-8">
                                    ...
                                    {{-- <div class="d-flex flex-wrap">
                                        ...
                                        <div
                                            ...
                                            <!--end::Number-->
                                            <!--begin::Label-->
                                            <div class="fw-semibold fs-6 text-gray-500">Credit
                                            </div>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Stat-->
                                        ...
                                        <div
                                            ...
                                            <!--end::Number-->
                                            <!--begin::Label-->
                                            <div class="fw-semibold fs-6 text-gray-500">Hours
                                            </div>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Stat-->
                                        ...
                                        <div
                                            ...
                                            <!--end::Number-->
                                            <!--begin::Label-->
                                            <div class="fw-semibold fs-6 text-gray-500">Attendance
                                            </div>
                                            <!--end::Label-->
                                        </div>
                                        <!--end::Stat-->
                    ...
                    <ul
                        ...
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5"
                               href="profile-billing.html">Billing</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5"
                               href="profile-statement.html">Statement</a>
                        </li>
                        <!--end::Nav item-->
                        <!--begin::Nav item-->
                        <li class="nav-item mt-2">
                            <a class="nav-link text-active-primary ms-0 me-10 py-5"
                               href="profile-logs.html">Logs</a>
                        </li>
                        <!--end::Nav item-->
                    </ul>
                    <!--begin::Navs-->
									...
									<form id="kt_account_profile_details_form" class="form" method="post" action="{{ route('user.update', $user->id) }}" enctype="multipart/form-data">
										...
										<div class="card-body border-top p-9">
												...
												<div class="col-lg-8">
													...
													<div class="image-input image-input-outline"
														...
														<div class="image-input-wrapper w-125px h-125px"
															style="background-image: url({{ $user->full_photo_path }});">
														</div>
													...
													<div class="row">
														...
														<div class="col-lg-6 fv-row">
															<input type="text" name="first_name"
																...
																placeholder="First name" value="{{ old('first_name')? old('first_name') : $user->first_name }}" required/>
														</div>
														<!--end::Col-->
														<!--begin::Col-->
														<div class="col-lg-6 fv-row">
															<input type="text" name="last_name"
																...
																placeholder="Last name" value="{{ old('last_name')? old('last_name') : $user->last_name }}" />
														</div>
														<!--end::Col-->
													</div>
													<!--end::Row-->
                                            ...
                                            <div class="row mb-6">
												...
												<div class="col-lg-8 fv-row">
													<input type="email" name="email"
														class="form-control form-control-lg form-control-solid"
														placeholder="Email" value="{{ old('email')? old('email') : $user->email }}" required />
												</div>
												<!--end::Col-->
											</div>
											<div class="row mb-6">
											...
											<div class="row mb-6">
												...
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
													<select name="user_type" aria-label="Select User Type"
														data-control="select2" data-placeholder="Select User Type..."
														class="form-select form-select-solid form-select-lg fw-semibold" required>
											...
											<div class="row mb-6">
												<!--begin::Label-->
												<label class="col-lg-4 col-form-label fw-semibold fs-6">Time
													Zone</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8 fv-row">
											...
											<div class="row mb-6">
												<!--begin::Label-->
												<label
													class="col-lg-4 col-form-label required fw-semibold fs-6">Gender</label>
												<!--end::Label-->
												<!--begin::Col-->
												<div class="col-lg-8 fv-row fv-plugins-icon-containe">
													<!--begin::Options-->
													<div class="d-flex align-items-center mt-3">
														<!--begin::Option-->
														<div class="mb-0 mx-3 col-auto">
															<div class="form-check">
																<input class="form-check-input" type="radio" value="male"
																	id="flexCheckDefault1" name="gender" {{ $user->gender == "male"? "checked" : ""}}>
														...
														<div class="mb-0 mx-3  col-auto">
															<div class="form-check">
																<input class="form-check-input" type="radio" value="female"
																	id="flexCheckChecked1" name="gender" {{ $user->gender == "female"? "checked" : ""}}>
											...
											{{-- <div class="row mb-6">
												<!--begin::Label-->
												<label class="col-lg-4 col-form-label fw-semibold fs-6">
													<span class="required">Rate Per Hour</span>
													<span class="ms-1" data-bs-toggle="tooltip"
														title="Phone number must be active">
														<i class="ki-duotone ki-information-5 text-gray-500 fs-6">
															<span class="path1"></span>
												...
												<div class="col-lg-8 fv-row">
													<input type="text" name="phone"
														class="form-control form-control-lg form-control-solid"
														placeholder="Rate Per Hour" value="044 3276 454 935" />
												</div>
												<!--end::Col-->
											</div> --}}
											<!--end::Input group-->
												...
												<div class="d-flex flex-stack flex-grow-1">
													...
													<div class="fw-semibold">
														...
														<div class="fs-6 text-gray-700">For extra security, this
															requires you to confirm your email

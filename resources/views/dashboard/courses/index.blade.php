...
@section('crumbs')
    ...
    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
        ...
        <!--end::Item-->
        <!--begin::Item-->
        <li class="breadcrumb-item text-dark">Courses</li>
        <!--end::Item-->
    </ul>
    <!--end::Breadcrumb-->
@endsection
                ...
                <div class="ol-md-4">
                    ...
                    <div class="card h-md-100">
                        ...
                        <div class="card-body d-flex flex-center">
                            <!--begin::Button-->
                            <a href="{{route('course.create')}}" class="btn btn-clear d-flex flex-column flex-center">
                                <!--begin::Illustration-->
                                <img src="{{asset('assets/media/illustrations/sketchy-1/4.png')}}" alt="" class="mw-100 mh-150px mb-7" />
                                <!--end::Illustration-->
                                <!--begin::Label-->
                                <div class="fw-bold fs-3 text-gray-600 text-hover-primary">Add New Course</div>
                                <!--end::Label-->
                            </a>
                            <!--begin::Button-->
                        </div>
                    ...
                    <div class="card card-flush h-md-100">
                        ...
                        <div class="card-body pt-1">
                            ...
                            <div class="fw-bold text-gray-600 mb-5">
                                Total users with this role: {{$course->users->count()}}
                            </div>
                            <!--end::Users-->
                            <!--begin::Permissions-->
                            <div class="d-flex flex-column text-gray-600">
                                <div class="d-flex align-items-center py-2">
                                    <span class="bullet bg-primary me-3"></span>{{$course->short_desc}}
                                </div>
                            </div>
                            <!--end::Permissions-->
                        </div>
                        ...
                        <div class="card-footer flex-wrap pt-0">
                            <a href="{{route('course.show' , $course->id)}}" class="btn btn-light btn-active-primary my-1 me-2">View Role</a>
                            <button type="button"  class="btn btn-danger delete_confirmation" data-role-url="{{ route('course.destroy' , $course->id) }}">Delete Role</button>                        </div>
                        <!--end::Card footer-->
                    </div>
                </div>
                @endforeach

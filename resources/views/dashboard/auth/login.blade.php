    ...
    <div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed"
            ...
            <div class="w-lg-500px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
                ...
                <form class="form w-100" action="{{route('auth.postLogin')}}" method="POST">
                    ...
                    <div class="text-center mb-10">
                        <!--begin::Title-->
                        <h1 class="text-dark mb-3">Sign In to Alustadh</h1>
                        <!--end::Title-->
                        <!--begin::Link-->
                    ...
                    <div class="fv-row mb-10">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control-lg form-control-solid" type="text" name="email" value="{{ old('userName') }}" />
                        @error('email')
                    ...
                    <div class="fv-row mb-10">
                        ...
                        <div class="d-flex flex-stack mb-2">
                            ...
                            <!--end::Label-->
                            <!--begin::Link-->
                            <a href="./password-reset.html" class="link-primary fs-6 fw-bolder">Forgot Password
                                ?</a>
                            <!--end::Link-->
                        </div>
                        <!--end::Wrapper-->
                    ...
                    <div class="text-center">
                        ...
                        <button type="submit" class="btn btn-lg btn-primary w-100 mb-5">
                            <span class="indicator-label">Sign Me In</span>
        ...
        <div class="d-flex flex-center flex-column-auto p-10">
            ...
            <div class="d-flex align-items-center fw-bold fs-6">
                <a href="https://alustadh.com/about-us/" class="text-muted text-hover-primary px-2">About</a>
{{--                <a href="mailto:support@keenthemes.com" class="text-muted text-hover-primary px-2">Contact</a>--}}
                <a href="https://alustadh.com/contact/" class="text-muted text-hover-primary px-2">Contact Us</a>
            </div>
            <!--end::Links-->
        </div>
        <!--end::Footer-->
